# read.TargetScan_hsa_nonconserved_site.R
...
org = 'hsa'
targetscan_hsa.file = "./TargetScanv7.1/hsa/Nonconserved_Site_Context_Scores.txt"
targetscan_hsa.data = read.delim(targetscan_hsa.file)	# 25847058 rows
...
#  3033005  1693259   897743 14279806  1920872  4390483  6759348  2909089  2344134    82565
if (SAME_ORG) {
...
targetscan_hsa.data$Gene.ID=gsub("\\.[0-9]*","",targetscan_hsa.data$Gene.ID)
targetscan_hsa.data$Transcript.ID=gsub("\\.[0-9]*","",targetscan_hsa.data$Transcript.ID)
targetscan_hsa.IDs = NULL
gs = unique(targetscan_hsa.data$Gene.ID)
targetscan_hsa.IDs = convert.gene.IDs(org=org, ID=gs, ID.type='mixed')
...
targetscan_hsa = cbind(org=org, targetscan_hsa, conserved_site='N')
...
if (DUMP.DB) {
    dump.file = "./SQL/multimir_mysqldump_after_read.TargetScan_hsa_nonconserved_site.R.sql"
...
save.image("read.TargetScan_hsa_nonconserved_site.RData")

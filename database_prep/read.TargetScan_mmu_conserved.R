# read.TargetScan_mmu_conserved.R
...
org = 'mmu'
targetscan_mmu.file = "./TargetScanv7.1/mmu/Conserved_Site_Context_Scores.txt"
targetscan_mmu.data = read.delim(targetscan_mmu.file)
...
#188332 171128  49992 301208  82774 229593 197382 209219 163015  19935 
if (SAME_ORG) {
...
targetscan_mmu = cbind(org=org, targetscan_mmu, conserved_site='Y')
...
if (DUMP.DB) {
    dump.file = "./SQL/multimir_mysqldump_after_read.TargetScan_mmu_conserved.R.sql"
...
save.image("read.TargetScan_mmu_conserved.RData")
